//! Helper functions for working with pg_lakehouse_core
//!
...
///
/// ```rust,no_run
/// # use pg_lakehouse_core::diag::report_info;
...
///
/// ```rust,no_run
/// # use pg_lakehouse_core::diag::report_notice;
...
///
/// ```rust,no_run
/// # use pg_lakehouse_core::diag::report_warning;
...
///
/// ```rust,no_run
/// # use pg_lakehouse_core::diag::report_error;
...
///
/// ```rust,no_run
/// # use pg_lakehouse_core::diag::{CreateRuntimeError, create_async_runtime};
