//! pg-lakehouse-core: A framework for building PostgreSQL Table Access Methods in Rust
//!
...
/// The prelude includes all necessary imports to make pg_lakehouse_core work
pub mod prelude {
...
pub use pg_lakehouse_macros::pg_table_am;
