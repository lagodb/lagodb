...
BEGIN
    LOOP
        ...
        IF clock_timestamp() >= deadline THEN
            RAISE EXCEPTION 'automatic maintenance initial compaction timed out';
        END IF;
...
CREATE TABLE automatic_maintenance_test.cold (id integer) USING iceberg;
INSERT INTO automatic_maintenance_test.cold VALUES (1);
INSERT INTO automatic_maintenance_test.cold VALUES (2);
INSERT INTO automatic_maintenance_test.cold VALUES (3);
INSERT INTO automatic_maintenance_test.cold VALUES (4);
INSERT INTO automatic_maintenance_test.cold VALUES (5);
INSERT INTO automatic_maintenance_test.cold VALUES (6);
UPDATE iceberg.iceberg_metadata
SET maintenance_due_at = NULL
WHERE relid = 'automatic_maintenance_test.cold'::regclass;

INSERT INTO automatic_maintenance_test.eligible VALUES (7);
INSERT INTO automatic_maintenance_test.eligible VALUES (8);
INSERT INTO automatic_maintenance_test.eligible VALUES (9);
INSERT INTO automatic_maintenance_test.eligible VALUES (10);
INSERT INTO automatic_maintenance_test.eligible VALUES (11);
INSERT INTO automatic_maintenance_test.eligible VALUES (12);
DO $$
DECLARE
    deadline timestamptz := clock_timestamp() + interval '30 seconds';
BEGIN
    LOOP
        ...
        IF clock_timestamp() >= deadline THEN
            RAISE EXCEPTION 'automatic maintenance write scheduling timed out';
        END IF;
        PERFORM pg_sleep(0.1);
    END LOOP;
END
...
FROM lakebase.table_maintenance_stats(
    'automatic_maintenance_test.cold'
);
