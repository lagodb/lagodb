...
pub(super) struct RowDeleteState {
    row_registry: RelationRowRegistry,
...
impl RowDeleteState {
    ...
    pub(super) fn finish(&self) -> IcebergResult<Vec<RowDeleteOutput>> {
    ...
    pub(super) fn referenced_data_files(&self) -> IcebergResult<BTreeSet<String>> {
