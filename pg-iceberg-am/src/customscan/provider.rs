//! Iceberg [`LakebaseCustomScanProvider`] implementation.
...
pub use super::provider_private_data::IcebergPrivateData;
pub use super::provider_scan_state::IcebergScanState;
...
impl LakebaseCustomScanProvider for IcebergCustomScanProvider {
    ...
    type PrivateData = IcebergPrivateData;
    ...
    fn create_path(
        ...
        let tablespace_oid = ctx.tablespace_oid();
        let fraction =
        ...
        Some(
            builder
                ...
                .private_data(IcebergPrivateData { tablespace_oid })
                .build(),
        )
    }
