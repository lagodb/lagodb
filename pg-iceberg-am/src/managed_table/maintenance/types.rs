...
use crate::engine::write::ExclusiveTransactionAction;
...
impl VacuumPolicy {
    pub(crate) fn new(
        ...
        Self {
            ...
            orphan_retention_ms: vacuum_orphan_retention_ms(),
        }
    }
}
...
impl ExclusiveTransactionAction for PreparedVacuum {
    ...
    fn conflict_error(&self) -> IcebergError {
        IcebergError::Vacuum {
            source: IcebergVacuumError::ActionConflict,
        }
    }
}
