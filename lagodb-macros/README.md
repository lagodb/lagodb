...
**Procedural macros for the LagoDB framework.**

This crate provides the macro support for `lagodb-core`. Its primary purpose is to reduce the boilerplate required to register custom storage handlers in PostgreSQL.
...
This crate is intended to be used as a dependency of `lagodb-core` and is re-exported there. Most users should simply use `lagodb_core::pg_table_am`.
