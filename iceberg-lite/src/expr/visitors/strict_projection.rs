...
mod tests {
    ...
    #[test]
    fn test_strict_projection_month_epoch() {
        let schema = Arc::new(
            Schema::builder()
                .with_fields(vec![
    ...
    #[test]
    fn test_strict_projection_month_lower_bound() {
        let schema = Arc::new(
            Schema::builder()
                .with_fields(vec![
                    Arc::new(NestedField::required(
    ...
    #[test]
    fn test_strict_projection_negative_month_lower_bound() {
        let schema = Arc::new(
            Schema::builder()
                .with_fields(vec![
                    Arc::new(NestedField::required(
    ...
    #[test]
    fn test_strict_projection_month_upper_bound() {
        let schema = Arc::new(
            Schema::builder()
                .with_fields(vec![
                    Arc::new(NestedField::required(
    ...
    #[test]
    fn test_strict_projection_negative_month_upper_bound() {
        let schema = Arc::new(
            Schema::builder()
                .with_fields(vec![
                    Arc::new(NestedField::required(
    ...
    #[test]
    fn test_strict_projection_negative_day() {
        let schema = Arc::new(
            Schema::builder()
                .with_fields(vec![
                    Arc::new(NestedField::required(
    ...
    #[test]
    fn test_strict_projection_year_lower_bound() {
        let schema = Arc::new(
            Schema::builder()
                .with_fields(vec![
                    Arc::new(NestedField::required(
    ...
    #[test]
    fn test_strict_projection_year_negative_lower_bound() {
        let schema = Arc::new(
            Schema::builder()
                .with_fields(vec![
                    Arc::new(NestedField::required(
    ...
    #[test]
    fn test_strict_projection_year_upper_bound() {
        let schema = Arc::new(
            Schema::builder()
                .with_fields(vec![
                    Arc::new(NestedField::required(
    ...
    #[test]
    fn test_strict_projection_bucket() {
    ...
    #[test]
    fn test_strict_projection_identity() {
        let schema = Arc::new(
            Schema::builder()
    ...
    #[test]
    fn test_strict_projection_truncate_lower_bound() {
        // int, long, decimal
        let schema = Arc::new(
            Schema::builder()
                .with_fields(vec![
    ...
    #[test]
    fn test_strict_projection_truncate_upper_bound() {
        let schema = Arc::new(
            Schema::builder()
                .with_fields(vec![
                    Arc::new(NestedField::required(
    ...
    #[test]
    fn test_strict_projection_truncate_string() {
        let schema = Arc::new(
            Schema::builder()
