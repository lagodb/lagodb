...
impl ArrowReader {
    ...
    fn process_file_scan_task(
        ...
        let missing_field_ids = initial_reader_builder
            .schema()
            .fields()
            .iter()
            .next()
        ...
        let mut record_batch_reader_builder = if missing_field_ids {
            ...
            let arrow_schema = if let Some(name_mapping) = &task.name_mapping {
                ...
                apply_name_mapping_to_arrow_schema(
                    Arc::clone(initial_reader_builder.schema()),
                    name_mapping,
                )?
            } else {
...
message schema {
  ...
  optional fixed_len_byte_array(17) c3 (DECIMAL(39,3)) = 3;
    ...
    #[test]
    fn test_position_delete_across_multiple_row_groups() {
    ...
    #[test]
    fn test_position_delete_with_row_group_selection() {
        use arrow_array::{Int32Array, Int64Array};
        use parquet::file::reader::{FileReader, SerializedFileReader};
    ...
    #[test]
    fn test_position_delete_in_skipped_row_group() {
        use arrow_array::{Int32Array, Int64Array};
        use parquet::file::reader::{FileReader, SerializedFileReader};
