...
impl<'a> HistoryTable<'a> {
    ...
    pub fn scan(&self) -> Result<ArrowRecordBatchIterator> {
        ...
        let mut made_current_at = PrimitiveBuilder::<TimestampMicrosecondType>::new()
...
mod tests {
    ...
    /// log entry.
    #[test]
    fn test_history_table_with_rolled_back_snapshot() {
        let metadata_json = r#"{
            "format-version": 2,
    ...
    #[test]
    fn test_history_table_with_parent_cycle() {
        let metadata_json = r#"{
            "format-version": 2,
            "table-uuid": "9c12d441-03fe-4693-9a96-a0705ddf69c1",
            "location": "s3://bucket/test/location",
    ...
    /// full history schema.
    #[test]
    fn test_history_table_with_empty_snapshot_log() {
        let metadata_json = r#"{
            "format-version": 2,
            "table-uuid": "9c12d441-03fe-4693-9a96-a0705ddf69c1",
            "location": "s3://bucket/test/location",
    ...
    #[test]
    fn test_history_table_without_current_snapshot() {
        let metadata_json = r#"{
            "format-version": 2,
            "table-uuid": "9c12d441-03fe-4693-9a96-a0705ddf69c1",
            "location": "s3://bucket/test/location",
