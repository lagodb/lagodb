...
impl TableBuilder {
    ...
    pub fn metadata_location<T: Into<String>>(
        mut self,
        metadata_location: T,
    ) -> Self {
...
impl Table {
    ...
    pub(crate) fn with_metadata_location(
        mut self,
...
/// # use iceberg_lite::table::StaticTable;
/// # use iceberg_lite::TableIdent;
/// fn example() {
...
mod tests {
    ...
    #[test]
    fn test_static_table_from_file() {
        ...
        let file_io = FileIO::from_path(&metadata_file_path).unwrap();
    ...
    fn test_table_readonly_flag() {
        ...
        let metadata_file_content = metadata_file.read().unwrap();
        let table_metadata =
