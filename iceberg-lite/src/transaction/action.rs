...
mod tests {
    ...
    use crate::transaction::action::{
        ActionCommit, ApplyTransactionAction, TransactionAction,
    };
    ...
    impl TransactionAction for TestAction {
        fn commit(self: Arc<Self>, _table: &Table) -> Result<ActionCommit> {
            Ok(ActionCommit::new(
    ...
    #[test]
    fn test_commit_transaction_action() {
    ...
    fn test_action_commit() {
        ...
        let mut action_commit =
            ActionCommit::new(updates.clone(), requirements.clone());
