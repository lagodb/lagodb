...
mod _const_schema {
    ...
    use crate::spec::{
        ListType, NestedField, NestedFieldRef, PrimitiveType, Schema, StructType,
        Type,
    };
...
pub(super) mod _serde {
    ...
    fn convert_to_serde_key_metadata(
...
mod test {
    ...
    fn test_manifest_list_writer_v1() {
        ...
        let mut writer =
            ManifestListWriter::v1(output_file, 1646658105718557341, Some(0));
        writer
    ...
    fn test_manifest_list_writer_v2() {
        ...
        let mut writer =
            ManifestListWriter::v2(output_file, snapshot_id, Some(0), seq_num);
        writer
            .add_manifests(expected_manifest_list.entries.clone().into_iter())
            .unwrap();
        writer.close().unwrap();
