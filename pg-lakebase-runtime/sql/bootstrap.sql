...
CREATE SEQUENCE lakebase.worker_id_seq AS integer;
...
CREATE TABLE lakebase.workers (
    worker_id integer PRIMARY KEY DEFAULT nextval('lakebase.worker_id_seq'),
...
ALTER SEQUENCE lakebase.worker_id_seq OWNED BY lakebase.workers.worker_id;
