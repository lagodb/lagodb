...
const SUPERVISOR_FUNCTION: &str = "pg_lakebase_runtime_supervisor_main";
pub(super) const COORDINATOR_FUNCTION: &str = "pg_lakebase_runtime_coordinator_main";
pub(super) const WORKER_FUNCTION: &str = "pg_lakebase_runtime_worker_main";
pub(super) const LIBRARY_NAME: &str = "pg_lakebase_runtime";
pub(super) const COORDINATOR_TYPE: &str = "pg-lakebase coordinator";
pub(super) const WORKER_TYPE: &str = "pg-lakebase worker";
...
pub(crate) fn init() {
    ...
    BackgroundWorkerBuilder::new("pg-lakebase supervisor")
        .set_type("pg-lakebase supervisor")
