...
//! # Background
//!
//! This is an implementation of `pg_lakehouse_core::access::xact::PendingDelete`
...
use pg_lakehouse_core::access::xact::{PendingDelete, register_pending_delete};
...
impl PendingDelete for IcebergPendingDelete {
    fn execute(&self) {
        ...
        if let Err(e) = self.file_io.remove_dir_all(&self.location) {
            pg_lakehouse_core::diag::report_warning(&format!(
