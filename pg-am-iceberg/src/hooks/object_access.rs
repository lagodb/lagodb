...
use pg_lakehouse_core::handles::{RelationHandle, TableGuard};
use pg_lakehouse_core::hooks::{ObjectAccessContext, ObjectAccessHook, ObjectAccessHookError};
use pgrx::pg_sys;
...
pub fn init_hook() {
    pg_lakehouse_core::hooks::register_object_access_hook(Box::new(IcebergObjectAccessHook));
}
