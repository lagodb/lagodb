...
struct ModifyProviderEntry<P: LagodbCustomModifyProvider> {
    _marker: PhantomData<fn() -> P>,
}

impl<P: LagodbCustomModifyProvider> ModifyProviderEntry<P> {
    const fn new() -> Self {
        Self {
            _marker: PhantomData,
        }
...
unsafe impl<P: LagodbCustomModifyProvider> Sync for ModifyProviderEntry<P> {}

impl<P: LagodbCustomModifyProvider> ErasedModifyProvider for ModifyProviderEntry<P> {
    fn type_id(&self) -> TypeId {
        TypeId::of::<P>()
    }
