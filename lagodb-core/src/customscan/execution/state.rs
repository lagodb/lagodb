...
#[repr(C)]
pub struct CustomScanStateWrapper<P: LagodbCustomScanProvider> {
    ...
    /// Decoded provider [`PrivateData`](LagodbCustomScanProvider::PrivateData).
...
impl<P: LagodbCustomScanProvider> Drop for CustomScanStateWrapper<P> {
    fn drop(&mut self) {
