...
`lagodb-core` is the reusable framework layer between PostgreSQL's C engine interfaces and concrete lakehouse table format implementations.
...
A storage provider implements safe Rust traits defined by `lagodb-core`:
