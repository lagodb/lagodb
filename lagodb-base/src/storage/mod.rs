...
//! server is a cluster singleton owned by the `lagodb_base` extension:
...
const LIBRARY_NAME: &str = "lagodb_base";
const WORKER_FUNCTION: &str = "lagodb_base_storage_bgworker_main";
...
#[pg_guard]
#[unsafe(no_mangle)]
pub extern "C-unwind" fn lagodb_base_storage_bgworker_main(_arg: pg_sys::Datum) {
